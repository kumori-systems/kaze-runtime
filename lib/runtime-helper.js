...
class RuntimeHelper {
    ...
    imageDataFromUrn(urn) {
        ...
        let imageTagName = domainConfig.tagPrefix + urnParts.imageRoot + ':' +
            urnParts.imageVersion;
        let escapedImageRoot = this.applySubstitutions(urnParts.imageRoot, domainConfig.tagToRepoSubstitutions);
...
//# sourceMappingURL=runtime-helper.js.map